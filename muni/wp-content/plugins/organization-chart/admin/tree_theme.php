...
class wpda_org_chart_tree_theme_page{
	...
	/*############  Function for returning the parameters ################*/	
	...
	/*############  Function for getting the default values ################*/
	...
	/*############  Function for the controller page ################*/
...
/*############  Update theme ID function  ################*/
	...
	/*############ Function for displaying the table list of themes ################*/
	...
	private function display_table_list_theme(){	
        ...
        <div class="wrap">
			...
			<div class="wpdevart_plugins_header div-for-clear">
				...
				<a target="blank" href="<?php echo wpda_org_chart_support_url; ?>" class="wpdevart_support">Have any Questions? Get a quick support!</a>
			</div>	
...
jQuery(document).ready(function(e) {
	...
	/*############ Function for generating the json list ################*/
	...
	/*############  Function for generating the chart theme parameters ################*/	
	...
	/*############  Function for adding/editing the theme ################*/
	...
	/*############  Function for setting the default theme ################*/
