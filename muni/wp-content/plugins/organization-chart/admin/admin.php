...
class wpda_org_chart_admin_main{
	...
	/*############  Function for the chart admin page ################*/
	...
	/*############  Function for the featured plugin ################*/
	...
	/*############  Function for the featured plugins ################*/
	...
	public function featured_plugins(){
		$plugins_array=array(
			...
			'lightbox'=>array(
						...
						'description'	=>	'WordPress Lightbox Popup is a high customizable and responsive plugin for displaying images and videos in a popup.'
						),
			'facebook'=>array(
